...
<template>
	<label class="formField">
		...
		<div class="formControl">
			<input v-if="type !== 'textarea' && type !== 'select'" :type="type || 'text'" :placeholder="placeholder"
				v-model="inner" class="fieldInput" />

			<textarea v-else-if="type === 'textarea'" :rows="rows || 3" :placeholder="placeholder" v-model="inner"
				class="fieldTextarea" />
